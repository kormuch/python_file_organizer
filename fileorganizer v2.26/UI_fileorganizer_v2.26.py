...
import fileorganizer_v2_26 as fileorganizer
import json

root = Tk()
root.title('File Organiser V2.26')
...
# configure the grid
label_main = Label(second_frame,
                     text="File Organizer V0.1",
                     font=(helv12_bold),
                     bd=1, 
                     justify="left")
label_main.grid(column=1, columnspan=10, row=2, sticky=W, pady=10, padx=10, ipadx=1, ipady= 10)


#creating labels
label_sourcefiles = Label(second_frame, text=f"Sourcefiles:", font=helv12_bold)
label_sourcefiles.grid(column=1, columnspan=9, row=29, sticky=W, pady=(10,0), padx=10, ipadx=1, ipady= 0)

label_keywords = Label(second_frame, text=f"Keywords:", font=helv12_bold)
label_keywords.grid(column=25, columnspan=9, row=29, sticky=W, pady=(10,0), padx=20, ipadx=1, ipady= 0)

label_destination = Label(second_frame, text=f"Destination Folders:", font=helv12_bold)
label_destination.grid(column=75, columnspan=9, row=29, sticky=W, pady=(10,0), padx=10, ipadx=1, ipady= 0)

#creating a listbox with sourcefiles
listbox_sourcefiles = Listbox(second_frame, width=60, height=35, borderwidth=3)
listbox_sourcefiles.grid(column=1, columnspan=9, row=29, rowspan=125, sticky=W, pady=(0,0), padx=(10,0), ipadx=1, ipady= 1)
scrollbar = Scrollbar(second_frame)
scrollbar.grid(column=10, columnspan=9, row=30, rowspan=115, sticky=NS)
...
scrollbar.grid(column=1, columnspan=9, row=145, sticky=EW, padx=(10,0))
...
label_keywords_text_box_counter=0
#textbox 1
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=30, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
...
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=60, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
...
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=90, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
...
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=120, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
...
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=150, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
...
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=180, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
label_keywords_text_box_06 = Entry(second_frame, width=40)
label_keywords_text_box_06.grid(column=30, columnspan=9, row=180, sticky=W, pady=(10,0), padx=25, ipadx=1, ipady= 0)
...
display_keywords_text_box_06.grid(column=30, columnspan=9, row=190, sticky=W, pady=0, padx=(25,0), ipadx=1, ipady= 1)
...
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=210, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
...
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=240, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
...
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=270, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
...
label_keywords_text_box_counter+=1
label_keywords_text_box_number = Label(second_frame, text=f"{label_keywords_text_box_counter}", font=helv12_bold)
label_keywords_text_box_number.grid(column=40, columnspan=1, row=300, sticky=W, pady=(10,0), padx=0, ipadx=0, ipady= 0)
...
# listbox 1
dst_folder_name_01 = Label(second_frame, text=f"")
...
# listbox 2
dst_folder_name_02 = Label(second_frame, text=f"")
...
# listbox 3
dst_folder_name_03 = Label(second_frame, text=f"")
...
# listbox 4
dst_folder_name_04 = Label(second_frame, text=f"")
...
# listbox 5
dst_folder_name_05 = Label(second_frame, text=f"")
...
# listbox 6
dst_folder_name_06 = Label(second_frame, text=f"")
...
# listbox 7
dst_folder_name_07 = Label(second_frame, text=f"")
...
# listbox 8
dst_folder_name_08 = Label(second_frame, text=f"")
...
# listbox 9
dst_folder_name_09 = Label(second_frame, text=f"")
...
# listbox 10
dst_folder_name_10 = Label(second_frame, text=f"")
...
def display_dst_listboxes():    
    ...
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            ...
            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword=[]
            for sourcefile in fileorganizer.os.scandir(fileorganizer.dir_source_files):
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            ...
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            ...
            for sourcefile_to_be_moved in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                pass
            for sourcefile in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    continue
                else:
                    list_of_sourcefiles_seen_and_notToBeDisplayedAnymore.append(sourcefile.name)
                    list_of_sourcefiles_seen_and_notToBeDisplayedAnymore=list(set(list_of_sourcefiles_seen_and_notToBeDisplayedAnymore))
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_01.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass


   
    #sourcefiles from textbox 2
    listboxcounter+=1
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved = []
                ...
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved.append(sourcefile)
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            dst_folder_name_02.config(text=dstFolderName)
        ...
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_02.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass
    
    
    
    #sourcefiles from textbox 3
    listboxcounter+=1
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved = []
                ...
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved.append(sourcefile)
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            dst_folder_name_03.config(text=dstFolderName)
        ...
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_03.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass



    #sourcefiles from textbox 4
    listboxcounter+=1
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved = []
                ...
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved.append(sourcefile)
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            dst_folder_name_04.config(text=dstFolderName)
        ...
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_04.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass


    #sourcefiles from textbox 5
    listboxcounter+=1
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved = []
                ...
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved.append(sourcefile)
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            dst_folder_name_05.config(text=dstFolderName)
            display_files_list_box_05.delete(0,END)
            for sourcefile_to_be_moved in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                pass
            for sourcefile in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
        ...
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_05.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass


    #sourcefiles from textbox 6
    listboxcounter+=1
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved = []
                ...
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved.append(sourcefile)
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            dst_folder_name_06.config(text=dstFolderName)
            display_files_list_box_06.delete(0,END)
            for sourcefile_to_be_moved in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                pass
            for sourcefile in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
        ...
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_06.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass


    #sourcefiles from textbox 7
    listboxcounter+=1
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved = []
                ...
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved.append(sourcefile)
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            dst_folder_name_07.config(text=dstFolderName)
            display_files_list_box_07.delete(0,END)
            for sourcefile_to_be_moved in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                pass
            for sourcefile in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
        ...
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_07.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass

    #sourcefiles from textbox 8
    listboxcounter+=1
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved = []
                ...
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved.append(sourcefile)
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            dst_folder_name_08.config(text=dstFolderName)
            display_files_list_box_08.delete(0,END)
            for sourcefile_to_be_moved in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                pass
            for sourcefile in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
        ...
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_08.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass



    #sourcefiles from textbox 9
    listboxcounter+=1
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved = []
                ...
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved.append(sourcefile)
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            dst_folder_name_09.config(text=dstFolderName)
            display_files_list_box_09.delete(0,END)
            for sourcefile_to_be_moved in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                pass
            for sourcefile in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
        ...
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_09.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass


    #sourcefiles from textbox 10
    listboxcounter+=1
    try:
        for dstFolderName, keywords_with_hashtags in list_of_dicts_dstFolderNames_and_keywords[listboxcounter].items():
            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved = []
                ...
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
                    ...
                    for keyword in keywords_without_hashtags:
                        ...
                        if keyword in sourcefile.name:
                            list_SrcFilesSeenFirstTime_and_therefore_to_be_moved.append(sourcefile)
                            list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.append("#" + keyword +": " + sourcefile.name)
            dst_folder_name_10.config(text=dstFolderName)
            display_files_list_box_10.delete(0,END)
            for sourcefile_to_be_moved in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                pass
            for sourcefile in list_SrcFilesSeenFirstTime_and_therefore_to_be_moved:
                if sourcefile in list_of_sourcefiles_seen_and_notToBeDisplayedAnymore:
        ...
        list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword.sort()
        for sourcefile_to_be_displayed in list_unseenSrcFiles_and_therefore_to_be_displayed_plus_keyword:
            display_files_list_box_10.insert(END, sourcefile_to_be_displayed)
    except IndexError:
            pass



# Get State: Check the Checkbox to extract files from folders
...
# Get State: Check the Checkbox to delete empty folders
...
def displaySourcefiles():
    listbox_sourcefiles.delete(0, END)
    for sourcefile in fileorganizer.os.scandir(fileorganizer.dir_source_files):
...
def loadKeywords():
    try:
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[0].items():
            label_keywords_text_box_01.delete(0, END)
            label_keywords_text_box_01.insert(END,key_textbox_label)
            display_keywords_text_box_01.delete("1.0", END)
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[1].items():
            label_keywords_text_box_02.delete(0, END)
            label_keywords_text_box_02.insert(END,key_textbox_label)
            display_keywords_text_box_02.delete("1.0", END)
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[2].items():
            label_keywords_text_box_03.delete(0, END)
            label_keywords_text_box_03.insert(END,key_textbox_label)
            display_keywords_text_box_03.delete("1.0", END)
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[3].items():
            label_keywords_text_box_04.delete(0, END)
            label_keywords_text_box_04.insert(END,key_textbox_label)
            display_keywords_text_box_04.delete("1.0", END)
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[4].items():
            label_keywords_text_box_05.delete(0, END)
            label_keywords_text_box_05.insert(END,key_textbox_label)
            display_keywords_text_box_05.delete("1.0", END)
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[5].items():
            label_keywords_text_box_06.delete(0, END)
            label_keywords_text_box_06.insert(END,key_textbox_label)
            display_keywords_text_box_06.delete("1.0", END)
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[6].items():
            label_keywords_text_box_07.delete(0, END)
            label_keywords_text_box_07.insert(END,key_textbox_label)
            display_keywords_text_box_07.delete("1.0", END)
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[7].items():
            label_keywords_text_box_08.delete(0, END)
            label_keywords_text_box_08.insert(END,key_textbox_label)
            display_keywords_text_box_08.delete("1.0", END)
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[8].items():
            label_keywords_text_box_09.delete(0, END)
            label_keywords_text_box_09.insert(END,key_textbox_label)
            display_keywords_text_box_09.delete("1.0", END)
        ...
        for key_textbox_label, value_textbox_keywords in json_object_data[9].items():
            label_keywords_text_box_10.delete(0, END)
            label_keywords_text_box_10.insert(END,key_textbox_label)
            display_keywords_text_box_10.delete("1.0", END)
...
Checkbutton(second_frame, variable=state_extract_boolean, onvalue=1, 
            offvalue=0, command=get_state_extract_from_folders).grid(column=1, columnspan=1, row=5, sticky=W, padx=(0,0), ipadx=10, ipady= 10)


state_delete_boolean=IntVar()
Checkbutton(second_frame, variable=state_delete_boolean, onvalue=1, 
            offvalue=0, command=get_state_delete_emptyFolders).grid(column=5, columnspan=1, row=5, sticky=W, padx=(0,0), ipadx=10, ipady= 10)


button_delete_emptyFolders = Button(second_frame,
                               text = "delete empty\nsourcefolders",
                               bg = "lightyellow",
                               font= ('Arial 12'),
                               command = lambda:[
                                   fileorganizer.delete_empty_folder_in_source_files()
                                   ])
button_delete_emptyFolders.grid(column=6, columnspan=1, row=5, sticky=W, padx=(0,0), pady=(10,10), ipadx=0, ipady=10)



button_extract_files = Button(second_frame,
                               text = "extract files\nfrom sourcefolders",
                               bg = "lightyellow",
                               font= ('Arial 12'),
                               command = lambda:[
                                   fileorganizer.extract_files_from_subfolder_in_source_files()
                                   ])
button_extract_files.grid(column=2, columnspan=1, row=5, sticky=W, padx=(0,0), pady=(10,10), ipadx=0, ipady=10)
...
button_check_for_keywords.grid(column=31, row=5, sticky=W, padx=(0,0), pady=(10,10), ipadx=10, ipady=10)
...
button_Run_File_Organizer = Button(second_frame,
                               ...
                               command = lambda:[
                                   save_content_textboxes(),
                                   fileorganizer.move_sourcefiles(),
                                   display_dst_listboxes(),
                                   displaySourcefiles()
                                   ])
button_Run_File_Organizer.grid(column=80, row=5, sticky=W, padx=(10,0), pady=(10,10), ipadx=10, ipady=10)



# The setup - loading sourcefiles and filling the listboxes at the start
displaySourcefiles()
loadKeywords()
